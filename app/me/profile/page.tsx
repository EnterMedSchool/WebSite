...
export default function ProfileEducationPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-8">
      ...
      <p className="text-gray-600">Select your university, school, course and study year. Your request must be approved before you can access your Course Mates. For privacy, nothing is shared until approved.</p>
