  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="pointer-events-none absolute left-0 top-1/2 -z-10 h-8 -translate-y-1/2 rounded-full bg-white/15 shadow-[0_6px_18px_rgba(99,102,241,0.25)] transition-[transform,width,opacity] duration-300 ease-out"
      />
