                  ...
                  {bookmarks.map((c) => (
                    <li key={c.id} className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4">
                      ...
                      <div className="mt-3 flex gap-2 text-xs">
                        <Link href={`${baseHref}/practice/${c.id}`} className="rounded-full bg-indigo-500 px-3 py-1 text-white hover:bg-indigo-400">
                          Open
                        </Link>
                        <Link href={`${baseHref}/debrief/${c.id}`} className="rounded-full bg-slate-800 px-3 py-1 text-slate-200 hover:bg-slate-700">
                          Debrief
                        </Link>
                      </div>
                    </li>
